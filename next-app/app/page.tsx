                                ...
                                <ScrollStackItem>
                                    <article className="lab-project" data-cursor="OPEN PROJECT" data-project="contract">
                                        <div className="project-art p1">
                                            <span className="project-num">01 / REASON — CLIENT 1</span>
                                ...
                                <ScrollStackItem>
                                    <article className="lab-project" data-cursor="OPEN PROJECT" data-project="sop">
                                        <div className="project-art p2">
                                            <span className="project-num">02 / RETRIEVE — CLIENT 1</span>
                                ...
                                <ScrollStackItem>
                                    <article className="lab-project" data-cursor="OPEN PROJECT" data-project="doc">
                                        <div className="project-art p3">
                                            <span className="project-num">03 / CREATE — CLIENT 2</span>
                ...
                <footer className="cways-footer-theme" id="contact">
                    <div className="cways-footer-inner">
                        ...
                        <ul className="cways-footer-pointers" style={{ listStyle: 'none', padding: 0, margin: '24px 0 32px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                            <li style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.98rem', color: '#444', fontWeight: 600 }}>
                                <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#111111', flexShrink: 0 }}></span>
                                Shaping the product &amp; defining AI strategy
                            </li>
                            <li style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.98rem', color: '#444', fontWeight: 600 }}>
                                <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#111111', flexShrink: 0 }}></span>
                                Rethinking workflows &amp; validating real feasibility
                            </li>
                            <li style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.98rem', color: '#444', fontWeight: 600 }}>
                                <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#111111', flexShrink: 0 }}></span>
                                Building working prototypes to prove value fast
                            </li>
                            <li style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.98rem', color: '#444', fontWeight: 600 }}>
                                <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#111111', flexShrink: 0 }}></span>
                                Getting close to the problem to see what AI can actually make possible
                            </li>
                        </ul>
                ...
                <div className="search-results-list" id="searchResults">
                    ...
                    <div className="search-item" data-action="project" data-target="sop">
                        <div>
                            ...
                            <div className="search-item-sub">Veeva Vault RAG SOP discovery &amp; page citations</div>
                        </div>
                            ...
                            <div>
                                <div className="modal-spec-card">
                                    <div className="spec-item">
                                        <label>Role</label>
                                        <span id="modalRole">AI Product</span>
                                    </div>
                                    <div className="spec-item">
                                        <label>Domain</label>
